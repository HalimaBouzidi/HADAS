import pickle
from algo_model import Algorithm
from pymoo.model.duplicate import DefaultDuplicateElimination
from pymoo.model.individual import Individual
from pymoo.model.initialization import Initialization
from pymoo.model.mating import Mating

# Il faut changer ici pour le mettre en two stages (contineously)
# I have to define the second problem too =D
...
class GeneticAlgorithm(Algorithm):
    ...
    def _next(self):
        ...
        #directory="/home/halima/Desktop/co-exploration/Code/Multi_gpu_cnn/CoSearch_supernet/tmp_pop/"
        #with open(directory+'current_pop'+str(self.n_gen)+'.pkl', 'wb') as outp:
        #    pickle.dump(self.pop, outp, pickle.HIGHEST_PROTOCOL)
