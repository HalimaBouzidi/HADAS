...
def build_default_CIFAR10_data_loader(args):
    ...
    train_dataset = INDEXEDCIFAR10(root=args.dataset_dir, train = True, transform=train_transforms, download = True)
    val_dataset = INDEXEDCIFAR10(root=args.dataset_dir, train = False, transform=non_train_transforms, download = True)
